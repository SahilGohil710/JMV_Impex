...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: '/images/straight-copper-pipe.png',
    material: 'DHP-Cu (deoxidized, high phosphorus copper)',
  ...
  },
  {
    ...
    details: [
      { name: '45° Elbow', image: '/images/fitting-elbow-45.png' },
      { name: '90° Elbow', image: '/images/fitting-elbow-90.png' },
      { name: '90° Elbow Long Radius', image: '/images/fitting-elbow-90-long.png' },
      { name: 'Coupling', image: '/images/fitting-coupling.png' },
      { name: 'Reducing Coupling', image: '/images/fitting-reducing-coupling.png' },
      { name: 'Tee', image: '/images/fitting-tee.png' },
      { name: 'Connection Tubes', image: '/images/fitting-connection-tubes.png' },
    ],
    image: '/images/copper-fittings.png',
